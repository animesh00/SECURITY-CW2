  ...
  return (
    <Slider {...settings}>
      <div className="testimonial py-4 px-3">
        <div>
          <h6 className="mb-0 mt-3">"shop has completely transformed the way we run our store!"</h6>
        </div>
      ...
      <div className="testimonial py-4 px-3">
        <div>
          <h6 className="mb-0 mt-3">"Shop has made managing my store so much easier!"</h6>
        </div>
        <p className="fst-italic">
        ...
        <div className="d-flex align-items-center gap-4 mt-3">
          ...
          <div>
            <h6 className="mb-0 mt-3">Ram, Grocery Shop Owner</h6>
      ...
      <div className="testimonial py-4 px-3">
        ...
        <p className="fst-italic">
          "Shop has become my go-to platform for restocking my store. Their support team is always available, and their commitment to quality is unmatched."
        </p>
        <div className="d-flex align-items-center gap-4 mt-3">
          <img src={ava02} className="w-25 h-25 rounded-2" alt="" />
          <div>
            <h6 className="mb-0 mt-3">hari Singh</h6>
      ...
      <div className="testimonial py-4 px-3">
        <div>
          <h6 className="mb-0 mt-3">"Shop simplifies everything for us!"</h6>
        </div>
        <p className="fst-italic">
      ...
      <div className="testimonial py-4 px-3">
        ...
        <p className="fst-italic">
          "Shop provides everything I need in one place. Their eco-friendly options and competitive prices help me cater to my customers more effectively."
        </p>
        <div className="d-flex align-items-center gap-4 mt-3">
          <img src={ava02} className="w-25 h-25 rounded-2" alt="" />
          <div>
      ...
      <div className="testimonial py-4 px-3">
        <div>
          <h6 className="mb-0 mt-3">"Great products, great idea!"</h6>
        </div>
        <p className="fst-italic">
          "With Shop, I have access to high-quality products that my customers love. Their fast delivery ensures my shelves are always stocked."
        </p>
        <div className="d-flex align-items-center gap-4 mt-3">
          <img src={ava03} className="w-25 h-25 rounded-2" alt="" />
          <div>
